...
{
    g_message("WebPage has requested builder");
    ...
    g_print("Setting transport property\n");
    ...
    g_message("Calling builder function with options");
...
static bool setup_bridge_script(JSCContext *ctx, WebKitWebPage *page, gpointer userData)
{
    ...
    g_message("Firebolt builder setup completed");
    return finalResult;
}
