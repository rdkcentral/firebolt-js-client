...
inline constexpr int PAGE_STATE_UNAVAILABLE = 1001;
inline const char* INVALID_STATE_ERROR = "Invalid PageState pointer";

inline constexpr int BUILDER_BUILD_FAILED = 1002;
inline const char* BUILDER_BUILD_FAILED_ERROR = "Failed to build using transport";

inline constexpr int INVALID_PARAMETERS = 1002;
inline constexpr int PAGE_STATE_CLIENT_ID_MISSING = 1003;
inline constexpr int CLIENT_ID_MISMATCH = 1004;
inline constexpr int UNEXPECTED_ERROR = 1005;
...
JSCValue* create_result(JSCContext* ctx, bool success, int errorCode);
